...
public class PersonHant extends Application {
	...
	Button updateButton, showListButton, addButton, delButton, sasButton, resetButton, clearButton, savelistButton,
			fnbutton;
	...
	private static final String SERIALIZED_FILE_NAME = "Person1.xml";
